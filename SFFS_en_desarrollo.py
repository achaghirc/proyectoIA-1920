...
def SFFS(datos,variable_predictora):
    ...
    while len(añadidas) < tam-1: 
        ...
        if(len(solucion_actual)>2):
            ...
            solucion_actual,ganancia_solucion_actual,eliminadas = proceso_de_eliminacion(datos, solucion_actual, variable_predictora, 10, 10, ganancia_solucion_actual,eliminadas)
...
def proceso_de_eliminacion(datos,solucion_actual,variable_predictora,N_Exp,CV,ganancia_solucion_actual,eliminadas):
    ...
    peor_variable = calcular_peor_variable(datos,solucion_actual,variable_predictora,N_Exp,CV)
