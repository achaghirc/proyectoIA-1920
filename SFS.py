...
def SFS(datos, variable_predictora, D):
    ...
    while k<D:
        ...
        ganancia_solucion_actual = promedio.evaluacionRobusta.validacionCruzada(datos,atributos_de_la_solucion, 1, 5)
...
def calcular_mejor_variable(datos,variables,variable_predictora,solucion_actual):
    ...
    for i in range(tam-1):
        ...
        ganancia_del_atributo = promedio.evaluacionRobusta.validacionCruzada(datos,atributos_a_probar,10,20)
