# -*- coding: utf-8 -*-
"""
Created on Mon May  4 19:58:44 2020
...
dfm = pd.read_csv('titanic.csv', delimiter=',')
# ***** Reading headers ***** 
df_headersName=pd.read_csv('titanic.csv', nrows=1).columns.tolist()
# ***** class variable ***** 
targetName= 'Survived'
oldPerf= 0
# ***** classifier object ***** 
